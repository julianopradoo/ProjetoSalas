...
async function initializeDatabase() {
  ...
  try {
    ...
    await conn.query("CREATE DATABASE IF NOT EXISTS projetoSalas");
    await conn.query("USE projetoSalas");
    ...
    if (tables.length === 0) {
      ...
      console.log("O banco de dados 'projetoSalas' já possui tabelas");
    }
  } catch (err) {
